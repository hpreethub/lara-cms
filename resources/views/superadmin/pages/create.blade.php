...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" method="POST" action="{{route('superadmin.page.store')}}" enctype="multipart/form-data">
                @csrf
                <fieldset>
                ...
                <!-- Text input-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" id="textarea2" name="meta_description"></textarea>
                        </div>
                    </div>
